...
import com.portfoliobp.pbp.Dto.dtoEducacion;
import com.portfoliobp.pbp.Entity.Educacion;
import com.portfoliobp.pbp.Security.Controller.Mensaje;
import com.portfoliobp.pbp.Service.Seducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        return new ResponseEntity(new Mensaje("Se ha actualizado con exito"), HttpStatus.OK);
    }
}
